...
import com.zettamine.rainfal.dao.AnnualRainfallDAO;
import com.zettamine.rainfal.dao.AnnualRainfallDAOImpl;
...
public class AnnualRainfallServicesImpl implements AnnualRainfallServices {
	...
	public AnnualRainfallServicesImpl() throws ClassNotFoundException {
		dao = new AnnualRainfallDAOImpl();
	}

	public void addRainfallReport1(List<AnnualRainfall> rainfallList) {
